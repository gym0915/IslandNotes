# 89af112c-6398-49b5-88e1-197eb8b5b69d implementation handoff

This archive is the source of truth for turning the design into production code. Start from `island-notes-ios-prototype.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `island-notes-ios-prototype.html`
...
- A single self-contained `island-notes-ios-prototype.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `island-notes-ios-prototype.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
## Entry points
- `island-notes-ios-prototype.html`
...
- `IMG_5017.PNG`
- `IMG_5018.PNG`
- `island-notes-ios-prototype-preview.png`
- `灵动岛便签-MVP-Wayfinder.md`

## Coding checklist for AI tools
1. Inspect `island-notes-ios-prototype.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
